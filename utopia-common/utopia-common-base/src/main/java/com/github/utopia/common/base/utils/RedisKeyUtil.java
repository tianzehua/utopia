...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "smartcity:restPwd";
	private static final String ACTIVE_USER = "smartcity:activeUser";
	private static final String SEND_SMS_COUNT = "smartcity:sms:count";
	private static final String SEND_EMAIL_CODE = "smartcity:email:code";
	private static final String ACCESS_TOKEN = "smartcity:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "smartcity:file:upload_file_size";
